...
def download_pretrained_models(file_ids, save_path_root):
    ...
    raise NotImplementedError(
        ...
        "Place the required weight files manually into the models folder."
    )
...
def load_file_from_url(url, model_dir=None, progress=True, file_name=None):
    """Download a weight file to ``model_dir`` (must be an absolute path)."""
    import os
    ...
    if not os.path.exists(cached_file):
        ...
        safe_download(url, cached_file, filename)
    return cached_file
