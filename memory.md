...
- **Suite:** ALL GREEN — 242 checks + gates (details below)
...
**Total: 242 checks, all green at the dlsssr commit (20 nodes; package `ants/`).** Sandbox venv: numpy, opencv-python-headless,
