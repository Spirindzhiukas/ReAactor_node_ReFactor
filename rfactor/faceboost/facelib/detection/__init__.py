...
from .... import model_paths as _model_paths
from ..utils import load_file_from_url


def _facedetection_dir():
    return _model_paths.facedetection_path
...
def init_retinaface_model(model_name, half=False, device='cuda'):
    ...
    model_path = load_file_from_url(url=model_url, model_dir=_facedetection_dir(), progress=True, file_name=None)
